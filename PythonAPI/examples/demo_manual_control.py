...
class World(object):
    ...
    def restart(self):
        ...
        self.ladar_manager = CameraManager(self.player, self.hud, self._gamma)
        self.ladar_manager.transform_index = cam_pos_index
        self.ladar_manager.set_sensor(cam_index, notify=False)
